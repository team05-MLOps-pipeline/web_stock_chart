...
def dashboard():
    ...
    return render_template('stock_dashboard4.html', tickers=tickers)  # 종목 리스트를 HTML에 전달합니다.
...
def stock_chart(ticker):
    ...
    return render_template('stock_chart4.html', chart=chart_html, ticker=ticker)  # HTML을 웹 페이지에 전달합니다.
